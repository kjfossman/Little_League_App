...
import { updateAnnouncement } from '../actions/announcementActions.js'
import '../css_files/Announcement.css';

class AnnouncementForm extends Component {

    state = {
        subject: this.props.announcement.subject,
    ...
    handleOnSubmit = event => {  
        ...
        this.props.updateAnnouncement(this.state)
        this.setState({
            subject: '',
            content: ''
        })
        ...
        return (
            ...
            <div className="block">
                <form onSubmit={this.handleOnSubmit}>
                    ...
                    <input className='submit' type="submit" value="Edit Announcement"></input>
                </form>
            </div>
        );
    }
